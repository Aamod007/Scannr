...
class ICEGATEBridge:
    ...
    def __init__(self):
        self.client_cert = (
            (ICEGATE_CERT_PATH, ICEGATE_KEY_PATH) if os.path.exists(ICEGATE_CERT_PATH) else None
        )
    ...
    async def submit_clearance_result(
        self, clearance_id: str, lane: str, decision_time: float
    ) -> Dict:
